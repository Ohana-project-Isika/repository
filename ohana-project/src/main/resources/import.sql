...
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('childbackground.jpg', 'Ohana Kids', 'Gâtons nos enfants', '2021-12-01', '2021-12-01', '11:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 1), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('kidds.png', 'Sauvons les enfants', 'Contre la guerre', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 7), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('childhood.png', 'Une famille, un enfant', 'Mieux que l orphelinat', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 10), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
...
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('kidds.png', 'Bien éduquer ses enfants', 'Education', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 3), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('childhood.png', 'Jeux, danse', 'Divertissements pour enfants', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 133), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('childbackground.jpg', 'A l école', 'Contre la violence à l école', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 8), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('childbackground.jpg', 'Enfants, mirroir de la société', 'Enfants et société', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 2), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
INSERT INTO event (image_file_name, event_name, event_description, start_date, end_date, start_time, end_time, address_idAddress, ticketing_id) VALUES ('kidds.png', 'Ne grandissons pas vite', 'Fait par des enfants pour des enfants', '2022-01-01', '2022-01-01', '12:00', '05:00', (SELECT idAddress FROM Address WHERE numRue = 133), (SELECT id FROM ticketing WHERE ticketing_name = 'ticketing'));
...
# INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price, privatePerson_idPrivatePerson) VALUES ((SELECT id FROM Event WHERE event_name = 'Ohana Kids'), 'REDUCED1', 'METROPOLITAN', 10, 1);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Sauvons les enfants'), 'REDUCED1', 'METROPOLITAN', 5);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Une famille, un enfant'), 'REDUCED1', 'METROPOLITAN', 30);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Comment garder nos enfants près de nous'), 'REDUCED1', 'METROPOLITAN', 10);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Bien éduquer ses enfants'), 'REDUCED1', 'METROPOLITAN', 15);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Jeux, danse'), 'REDUCED2', 'METROPOLITAN', 25);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'A l école'), 'REDUCED2', 'METROPOLITAN', 35);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Enfants, mirroir de la société'), 'REDUCED1', 'METROPOLITAN', 40);
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price) VALUES ((SELECT id FROM Event WHERE event_name = 'Ne grandissons pas vite'), 'REDUCED1', 'METROPOLITAN', 50);
