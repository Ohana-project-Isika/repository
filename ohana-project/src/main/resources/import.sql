...
# ADDRESS TABLE
 ...
 INSERT INTO Address (numRue, rue, codePostal, ville, pays) VALUES (20, 'Alee Isika', '87000', 'Limoges', 'France');

INSERT INTO personinfo (lastName, firstName) VALUES ('ddfvfdsls', 'sdfvsd');

INSERT INTO contact (phoneNb, phoneNb2, email, personInfo_idPersInfo) VALUES ('fdsff', 'dfdds', 'qsdfsdffqsd', (SELECT idPersInfo FROM personinfo WHERE lastName = 'ddfvfdsls'));
