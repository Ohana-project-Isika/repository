...
INSERT INTO Ticket (event_id, rate_type, applied_TVA, pre_tax_price, privatePerson_idPrivatePerson) VALUES ((SELECT id FROM Event WHERE event_name = 'Ohana Kids'), 'REDUCED1', 'METROPOLITAN', 10, 2);
