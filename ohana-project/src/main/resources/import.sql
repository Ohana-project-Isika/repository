...
# TICKET TABLE
INSERT INTO Ticket (event_id, rate_type, applied_TVA) VALUES ((SELECT id FROM Event WHERE event_name = 'gggggg'), 'REDUCED1', 'METROPOLITAN');
INSERT INTO Ticket (event_id, rate_type, applied_TVA) VALUES ((SELECT id FROM Event WHERE event_name = 'nnnnnn'), 'REDUCED1', 'METROPOLITAN');
